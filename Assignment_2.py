...
pr_manifacture_cost = float(input("Please enter the Produc Manifacture Cost: "))
...
print("Manifacture Cost:", pr_manifacture_cost, "CAD")
...
if month == 12:
    print("Net Profit:", (total_sold * pr_price) - (total_manif * pr_manifacture_cost), "CAD")